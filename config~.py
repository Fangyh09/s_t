...
class Config():
    ...
    filename_trimmed = "data/glove.6B.{}d.trimmed.bieo.npz".format(dim_word)
    use_pretrained = True

    # dataset
    if DEBUG_MODE:
        filename_dev = "data/dev.eval.small"
        filename_test = "data/dev.eval.small"
        filename_train = "data/train.eval.small"
    else:
        filename_dev = "data/dev.eval"
        filename_test = "data/dev.eval"
